...
// 				$this->lx->session_save_enc("photo", $profile_picture);
	...
	function get_user_structure($user_id) {
		$sql = "SELECT os.organization_structure_id, os.unit_name, us.*, dir.unit_name AS instansi, os.unit_code
	...
	function check_email_exist($email) {
		return $this->db->get_where('system_security.users', array('email' => $email));
	}
