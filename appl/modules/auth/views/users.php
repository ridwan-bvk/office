...
<section class="content">
	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class="well">
				<div class="btn-group">
					<button type="button" name="btnAdd" class="btn btn-primary" onclick="location.assign('<?php echo site_url('auth/user/user_add'); ?>')"><i class="fa fa-plus"></i> Add</button>
				</div>
			</div>
...
?>
					<tr>
						...
						<td>
							<a class="btn btn-info" href="#" onclick="location.assign('<?php echo site_url('auth/user/user_edit/' . $row->user_id); ?>')" title="Edit"><i class="fa fa-edit "></i></a>
