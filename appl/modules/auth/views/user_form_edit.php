...
?>
					<img id="user_profile" class="profile-user-img img-responsive img-circle" src="<?php echo $data->profile_picture ? $data->profile_picture : '/lx_media/photo/m.jpg'; ?>" alt="User profile picture" style="height:128px; width:128px;">
...
?>
							...
							<tr>
								<td valign="top"><a href="javascript:void()" onclick="resendActivation()">Resend activation code</a></td>
