...
<?php 
	...
	foreach($menu_list->result() as $sub_row) {
		if($sub_row->permission_access == 0 || has_permission($sub_row->permission_access)) {
			if ($sub_row->function_ref_name != "Disposisi") {
?>
						...
						<!-- Notifications: style can be found in dropdown.less -->
				          <li class="dropdown notifications-menu">
				            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
				              ...
				              <span class="label label-warning"><?php echo count($notify); ?></span>
				            </a>
...
?>				                
				                  <li>
				                    <a href="<?php echo site_url() . $row->detail_link; ?>">
...
<?php
*/
	if(file_exists( str_replace('/lx_media', '<?php echo assets_url(); ?>/assets/media/', get_user_data('photo')))) {
