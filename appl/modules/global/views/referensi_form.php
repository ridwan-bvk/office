					...
					success: function(data){//alert(data);
						if(typeof(data.error) != 'undefined') {
							if(data.error != '') {
								...
								alert(data.msg);
								location.assign('<?php echo str_replace($this->config->item('url_suffix'), "", site_url('global/admin/referensi')); ?>');
							}
						} else {
...
<?php 
	...
	echo form_hidden('action', 'global.admin_model.save_referensi');
	...
	<div class="box">
		...
		<div class="box-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
<?php 
	$tipe = $this->admin_model->get_system_config('referensi');
...
?> &nbsp; Aktif
			...
			<div class="well">
				<div class="col-md-6">
					<div class="btn-group">
						<button type="button" id="btnBack" class="btn btn-primary" name="btnBack" onclick="location.assign('<?php echo site_url('global/admin/referensi'); ?>')" ><i class="fa fa-chevron-left"></i> Back</button>
			
<?php 
	if($mode != 'add') {
?>
						<button type="submit" id="btnSave" class="btn btn-primary" name="btnSave" ><i class="fa fa-check"></i> Update</button>
						<button type="button" id="btnAdd" class="btn btn-primary" name="btnAdd" onclick="location.assign('<?php echo site_url('global/admin/referensi_detail'); ?>')" ><i class="fa fa-plus"></i> Add New</button>
<?php 
	} else {
?>
