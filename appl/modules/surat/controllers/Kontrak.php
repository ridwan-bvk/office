...
class Kontrak extends LX_Controller {
	
	var $func_kontrak_main = 5;
	...
	function __construct() {
		...
		$this->load->model(array('auth/user_model', 'global/admin_model', 'eksternal_model', 'surat_model', 'disposisi_model', 'kontrak_model'));
...
// 				assets_url() . '/plugins/datepicker/bootstrap-datepicker.js'
	 ...
	 */
	function input_kontrak($surat_id = NULL) {
		$this->output_head['function'] = __FUNCTION__;
		$this->output_head['style_extras'] = array(assets_url() . '/plugins/iCheck/all.css',
													'//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css',
...
//  											assets_url() . '/plugins/datepicker/bootstrap-datepicker.js'
		...
		$this->output_head['js_function'] = array();
		$this->output_head['search_type'] = 'surat_kontrak_maintenance';
		$this->load->view('global/header', $this->output_head);
	
		$this->output_data['title'] = 'Contract Maintenance';
		$this->output_data['function_ref_id'] = $this->func_kontrak_main;
		...
		if($surat_id == NULL) {
			...
			$this->load->view('contract_maintenance_form_add', $this->output_data);
			
		} 
		$this->load->view('global/footer');
	}
	
	function input_addendum1($surat_id) {
...
function input_addendum2($surat_id) {
...
//  											assets_url() . '/plugins/datepicker/bootstrap-datepicker.js'
	 ...
	 * @param unknown $surat_id
	 */
	function kontrak_view($surat_id) {
		...
		$this->load->view('contract_maintenance_form_view', $this->output_data);
	
	}
	
	function ubah_kontrak($surat_id = NULL) {
		$this->output_head['function'] = __FUNCTION__;
		$this->output_head['style_extras'] = array(assets_url() . '/plugins/iCheck/all.css',
													'//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css',
													assets_url() . '/plugins/jQueryUI/jquery-ui-timepicker-addon.css',
...
//  											assets_url() . '/plugins/datepicker/bootstrap-datepicker.js'
		...
		if($surat_id == NULL) {
			...
			if(!has_permission(1)) {
				if($surat->status == 99) {
					$view = 'contract_maintenance_form_view';
				} else {
					if(editable_data($this->func_kontrak_main, get_role(), $surat->surat_id)) {
						$view = 'contract_maintenance_form_edit';
					} else {
						$view = 'contract_maintenance_form_view';
					}
				}
	...
	function ubah_addendum1($surat_id = NULL) {
		$this->output_head['function'] = __FUNCTION__;
		$this->output_head['style_extras'] = array(assets_url() . '/plugins/iCheck/all.css',
													'//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css',
													assets_url() . '/plugins/jQueryUI/jquery-ui-timepicker-addon.css',
...
//  											assets_url() . '/plugins/datepicker/bootstrap-datepicker.js'
		...
		if($surat_id == NULL) {
			...
			$result = $this->kontrak_model->get_addendum($surat_id);
			if($result->num_rows() == 0) {
				set_error_message('Data tidak dikenali.');
				redirect('global/dashboard');
				exit;
			...
			$addendum = $result->row();
			$this->output_data['surat'] = $addendum;
			...
			if($addendum->status != 99) {
				$result = $this->admin_model->get_process($this->func_kontrak_main, $addendum->status);
				$process = $result->row();
			} else {
				$process = new stdClass();
				$process->flow_seq = 99;
			...
			if(!has_permission(1)) {
				if($addendum->status == 99) {
					$view = 'addendum_form_view';
				} else {
					if(editable_data($this->func_kontrak_main, get_role(), $addendum->surat_id)) {
						$view = 'addendum_form_edit';
					} else {
						$view = 'addendum_form_view';
					}
				}
	...
	function ubah_addendum2($surat_id = NULL) {
		$this->output_head['function'] = __FUNCTION__;
		$this->output_head['style_extras'] = array(assets_url() . '/plugins/iCheck/all.css',
													'//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css',
													assets_url() . '/plugins/jQueryUI/jquery-ui-timepicker-addon.css',
...
//  											assets_url() . '/plugins/datepicker/bootstrap-datepicker.js'
		...
		if($surat_id == NULL) {
			...
			$result = $this->kontrak_model->get_addendum2($surat_id);
			if($result->num_rows() == 0) {
				set_error_message('Data tidak dikenali.');
				redirect('global/dashboard');
				exit;
			...
			if(!has_permission(1)) {
				if($addendum->status == 99) {
					$view = 'addendum_form2_view';
				} else {
					if(editable_data($this->func_kontrak_main, get_role(), $addendum->surat_id)) {
						$view = 'addendum_form2_edit';
					} else {
						$view = 'addendum_form2_view';
					}
				}
	...
	function hentikan_kontrak($surat_id) {
...
//		}
	...
	function kontrak_selesai() {
		...
		$this->output_data['title'] = 'Contract Maintenance';
		$this->load->view('kontrak_selesai', $this->output_data);
		$this->load->view('global/footer');
		
	}
	function kontrak_aktif() {
		$this->output_head['function'] = __FUNCTION__;
		$this->output_head['style_extras'] = array(assets_url() . '/plugins/datatables/dataTables.bootstrap.css',
													assets_url() . '/plugins/select2/select2.min.css');
		...
		$this->output_data['title'] = 'Contract Maintenance';
		$this->load->view('kontrak_aktif', $this->output_data);
		$this->load->view('global/footer');
