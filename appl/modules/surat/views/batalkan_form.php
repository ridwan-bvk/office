...
?>
			...
			<div class="form-group">
				...
				<div class="col-lg-2 col-sm-3">
					<div class="input-group">
						<input type="text" id="surat_unit_lampiran" name="surat_unit_lampiran" readonly class="form-control dateselesaipicker required" data-input-title="tgl Berakhir" value="<?php echo db_to_human($surat->surat_unit_lampiran); ?>" >
						<div class="input-group-addon">
							<i class="fa fa-calendar"></i>
						</div>
					</div>
