...
<?php
	$hidden = array('action' => 'surat.kontrak_model.update_addendum1',
...
<?php 
	...
	echo form_dropdown('sifat_surat', $opt_kode_add, $surat->sifat_surat, (' id="sifat_surat" class="form-control" '));
?>
				</div>
...
<?php 
	...
	echo form_dropdown('jenis_surat', $opt_jenis_add, $surat->jenis_surat, (' id="jenis_surat" class="form-control" '));
?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-4 col-sm-9">
					<input type="text" id="surat_no" name="surat_no" class="form-control" placeholder="Nomor Addendum" data-input-title="Nomor Surat" value="<?php echo $surat->surat_no; ?>">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-2 col-sm-9">
					<div class="input-group">
						...
						<div class="input-group-addon">
							<i class="fa fa-calendar" title="Format dd-mm-yyyy"></i>
						</div>
					</div>
				</div>
