			...
			<div class="form-group">
				...
				<div class="col-lg-2 col-sm-3">
					<div class="input-group">
						...
						<input type="text" id="surat_unit_lampiran" name="surat_unit_lampiran" class="form-control dateselesaipicker" data-input-title="tgl Berakhir" value="<?php echo db_to_human($surat->surat_unit_lampiran); ?>">
						<?php }else { ?>
						<input type="text" id="surat_unit_lampiran" name="surat_unit_lampiran" class="form-control dateselesaipicker" data-input-title="tgl Berakhir" value="">
						<?php } ?>
						<div class="input-group-addon">
							<i class="fa fa-calendar"></i>
						</div>
