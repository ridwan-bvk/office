...
<?php
	...
	echo form_hidden('action', 'surat.kontrak_model.insert_kontrak'); 
	...
	echo form_hidden('jenis_agenda', 'CM'); 
	echo form_hidden('create_agenda', '1'); 
	
	echo form_hidden('surat_from_ref', 'Contract');
		...
		<div class="box-body">
			<div class="form-group">
				...
				<div class="col-lg-4 col-sm-9">
					<input type="text" id="surat_no" name="surat_no" class="form-control" placeholder="Nomor Kontrak" data-input-title="Nomor Surat" value="<?php echo set_value('surat_no'); ?>">
				</div>
...
<?php 
	...
	echo form_dropdown('status_berkas', $opt_mitra, '', (' id="status_berkas" class="form-control" '));
?>
				</div>
			</div>
...
<?php 
	...
	echo form_dropdown('jenis_surat', $opt_jenis_kontrak, '', (' id="jenis_surat" class="form-control" '));
?>
				</div>
...
<?php 
	...
	echo form_dropdown('sifat_surat', $opt_kode_kontrak, '', (' id="sifat_surat" class="form-control" '));
?>
				</div>
			</div>
				...
				<div class="col-lg-4 col-sm-9">
					<div class="input-group">
						<span class="input-group-addon">Rp</span>
							<input id="price" maxlength="21"  name="surat_ringkasan" class="form-control required" rows="3" placeholder="Nilai Kontrak" data-input-title="Nilai Kontrak" value="<?php echo set_value('surat_ringkasan'); ?>">
			...
			<div class="form-group">
				<label for="surat_unit_lampiran" title="Format dd-mm-yyyy" class="col-lg-2 col-sm-3 control-label">Tgl. Kontrak <br> (dd-mm-yyyy)</label>
				<div class="col-lg-2 col-sm-9">
					<div class="input-group">
						<input type="text" id="surat_unit_lampiran" name="surat_unit_lampiran" class="form-control datepicker required" data-input-title="Tanggal Surat" value="<?php echo date('d-m-Y'); ?>" onchange="tglMulaiChange();">
				...
				<div class="col-lg-2 col-sm-9">
<?php
	$mulai = new DateTime(date("Ymd"));
	//$mulai->modify('+1 day');
?>
					<div class="input-group">
						<input type="text" id="surat_tgl" name="surat_tgl" class="form-control datemulaipicker required" data-input-title="Tgl Terima" value="<?php echo $mulai->format('d-m-Y'); ?>" onchange="tglBerlakuChange();">
						<div class="input-group-addon">
							<i title="Format dd-mm-yyyy" class="fa fa-calendar"></i>
						</div>
					</div>
