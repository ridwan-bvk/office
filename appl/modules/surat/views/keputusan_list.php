...
<script type="text/javascript">
	...
	var isShow = false;
		$(document).ready(function() {
		 ...
		 $.fn.dataTable.ext.search.push(
	                function (settings, data, dataIndex) {
	                    var min = $('.minx').datepicker("getDate");
	                    var max = $('.maxx').datepicker("getDate");
	...
	<div class="box-list">
		...
		<div class="box-list ">
				<tr>
					...
					<td>Dari:</td>
	                <td><input  name="min" class="form-control2 min" type="text" onchange="tglSelesaiChange();"></td> 
	         ...
	         <br><br>
	    	   <tr>
					...
					<td>Dari:</td>
	                <td><input  name="minx" class="form-control2 minx" type="text" onchange="tglSelesaiChangex();"></td> 
