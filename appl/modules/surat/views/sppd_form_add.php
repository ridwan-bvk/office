		...
		<div id="list-tujuan" class="box-body">
			<fieldset id="row_penerima_0" style="position: relative;">
				...
				<div class="form-group">
					...
					<label for="sppd_tgl_berangkat_dari_0" class="col-sm-2 control-label">Tgl berangkat dari</label>
					<div class="col-lg-4 col-sm-9">
						<div class="input-group">
				...
				<div class="form-group">				
					<label for="sppd_tgl_tiba_di_0" class="col-sm-2 control-label">Tgl tiba di</label>
					<div class="col-lg-4 col-sm-9">
						<div class="input-group">
