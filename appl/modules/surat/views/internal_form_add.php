			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<input type="text" id="surat_to_unit" name="surat_to_ref_data[unit]" class="form-control required" data-input-title="Unit Tujuan" value="<?php echo set_value('surat_to_ref_data_unit'); ?>" placeholder="Bagian / Sub Bagian tujuan surat...">
			...
			<div class="box box-primary">
				...
				<div id="list-tembusan" class="box-body">
					<div id="row_tembusan_0" class="form-group">
						<div class="col-sm-12">
							<input type="text" id="tembusan_0" name="tembusan[0]" class="form-control" data-input-title="Tembusan 0" value="<?php echo set_value('tembusan[0]'); ?>" placeholder="Tembusan surat...">
						</div>
					</div>
...
?>
	...
	<div class="box box-primary">
		<div class="box-header with-border">
			<span class="h3 box-title">lampiran </span> <span class="small">Max. 2MB (*.pdf, *.jpg, *.jpeg, *.png) </span>
			<div class="box-tools pull-right">
...
//	var optSrtJab = '<?php //echo str_replace("\n", '', form_dropdown('surat_ttd[%0%][type_ttd]', $opt_ttd, (set_value('surat_to_penandatangan') ? set_value('surat_to_penandatangan') : 'Penandatangan' ), (' id="surat_to_penandatangan_%0%" class="form-control" ')) ); ?>';
	...
	function addTembusan() {
		...
		row = '<div id="row_tembusan_' + tembusanRow + '" class="form-group">' +
				'	<div class="col-sm-12">' +
				'		<div class="input-group">' +
				'			<input type="text" name="attachment[' + tembusanRow + '][title]" class="form-control" placeholder="Tembusan surat...">' +
