<?php
	$surat_to_ref_data = json_decode($ref->surat_to_ref_data, TRUE);
	$title = 'Surat Masuk Eksternal - ' . humanize($surat_to_ref_data['unit']);
?>
...
?>
					<tr>
						...
						<td width="100"><a href="<?php echo site_url('surat/external/incoming/' . $row->surat_id); ?>" target="_blank"> <?php echo strtoupper($row->jenis_agenda) . ' - ' . $row->agenda_id; ?></a></td>
						<td width="120">
							<?php echo $row->surat_no; ?><br>
							<?php echo db_to_human($row->surat_tgl); ?>
						</td>
						<td width="200">
							<?php echo $surat_from_ref_data['title']; ?><br>
							<?php echo $surat_from_ref_data['instansi']; ?>
						</td>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<input type="text" id="tujuan_unit" name="tujuan_unit" class="form-control required" data-input-title="Unit Tujuan" value="<?php echo $surat_to_ref_data['unit']; ?>" readonly="readonly">
								<div id="tujuan_unit_kode" class="input-group-addon"><?php echo $surat_to_ref_data['kode']; ?></div>	
								<input type="hidden" id="tujuan_kode" name="tujuan_kode" class="form-control required" data-input-title="Kode Instansi Unit" value="<?php echo $surat_to_ref_data['kode']; ?>">
								<input type="hidden" id="tujuan_unit_id" name="tujuan_unit_id" value="<?php echo $ref->surat_to_ref_id; ?>">
							</div>
						</div>
					</div>
					<div class="form-group">
...
<?php 
	...
	echo form_dropdown('tujuan_jabatan', $opt_jabatan, $surat_to_ref_data['jabatan'], (' id="tujuan_jabatan" class="form-control" data-input-title="Nama Jabatan" readonly="readonly" '));
?>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="tujuan_nama" name="tujuan_nama" class="form-control" data-input-title="Nama Pejabat Tujuan" value="<?php echo $surat_to_ref_data['nama']; ?>" readonly="readonly" >
						</div>
					</div>
					<div class="form-group">
						<label for="surat_int_dir" class="col-sm-3 control-label">Direktorat</label>
						<div class="col-sm-9">
							<input type="text" id="tujuan_dir" name="tujuan_dir" class="form-control" readonly="readonly" data-input-title="Direktorat Tujuan" value="<?php echo $surat_to_ref_data['dir']; ?>" >
						</div>
					</div>
				</div>
