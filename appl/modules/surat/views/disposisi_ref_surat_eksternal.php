	...
	<div class="box">
		...
		<div class="box-body">
			<div class="row">
				...
				<label class="col-md-10" style="font-weight: 400;"> : <?php echo $ref->surat_ext_nama . ' &nbsp; | &nbsp; ' . $ref->surat_ext_title . ' &nbsp; | &nbsp; ' . $ref->surat_ext_instansi; ?></label>
			</div>
			<div class="row">
...
?>
				...
				<div class="col-md-4">
<?php 
	list($surat_tgl_masuk_date, $surat_tgl_masuk_time) = explode(' ', $ref->surat_tgl_masuk);
