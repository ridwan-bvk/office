...
?>
					<tr>
						<td width="50"><input type="checkbox" name="detail_ekspedisi[]" class="detail-check" value="<?php echo $row->surat_id?>" checked="checked" > &nbsp; <?php echo $i++ ?>.</td>
						<td width="100"><a href="<?php echo ($row->function_ref_id != 3) ? site_url('surat/external/incoming/' . $row->surat_id) : site_url('surat/internal/sheet/' . $row->surat_id); ?>" target="_blank"> <?php echo strtoupper($row->jenis_agenda) . ' - ' . $row->agenda_id; ?></a></td>
						<td width="120">
