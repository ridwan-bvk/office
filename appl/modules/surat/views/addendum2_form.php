...
<?php
	$hidden = array('action' => 'surat.kontrak_model.insert_addendum2',
...
?>
	...
	<div class="box box-primary">
		<div class="box-header with-border" align="center">
			<h3 class="box-title" >ADDENDUM KONTRAK 2</h3>
...
?>	
				...
				<div class="col-lg-4 col-sm-9">
					<div class="input-group">
						<span class="input-group-addon">Rp</span>
							<input id="price" maxlength="21" name="surat_ringkasan" class="form-control required" rows="3" placeholder="Nilai Kontrak" data-input-title="Nilai Kontrak" value="<?php echo $addendum->surat_ringkasan; ?>"">
					</div>
				</div>
			...
			<div class="form-group">
				<label for="surat_unit_lampiran" title="Format dd-mm-yyyy" class="col-lg-2 col-sm-3 control-label">Tgl. Addendum <br> (dd-mm-yyyy)</label>
				<div class="col-lg-2 col-sm-9">
					<div class="input-group">
						<input type="text" id="surat_unit_lampiran" name="surat_unit_lampiran" class="form-control datepicker required" data-input-title="Tanggal Surat" value="<?php echo $addendum->surat_unit_lampiran; ?>" onchange="tglMulaiChange();">
				...
				<div class="col-lg-2 col-sm-9">
					<div class="input-group">
						<input type="text" id="surat_tgl" name="surat_tgl" class="form-control datemulaipicker required" data-input-title="Tgl Terima" value="<?php echo db_to_human($addendum->surat_tgl); ?>" onchange="tglBerlakuChange();">
						<div class="input-group-addon">
							<i  title="Format dd-mm-yyyy" class="fa fa-calendar"></i>
						</div>
					</div>
				...
				<div class="col-lg-2 col-sm-9">
					...
					<div class="input-group">
						<input type="text" id="surat_tgl_masuk" name="surat_tgl_masuk" class="form-control dateselesaipicker required" data-input-title="tgl Berakhir" VALUE="<?php echo db_to_human($addendum->surat_tgl_masuk); ?>">
						<div class="input-group-addon">
							<i title="Format dd-mm-yyyy" class="fa fa-calendar"></i>
						</div>
					</div>
...
// 			minDate : 0
		...
		<?php 
			  $waktu = db_to_human($addendum->surat_tgl); 
		...
		<?php 
			  $waktu_mulai = db_to_human($addendum->surat_tgl); 
		...
		<?php 
			  $waktu_selesai = db_to_human($addendum->surat_tgl_masuk); 
		...
		<?php 
			  $waktu_berlaku = db_to_human($addendum->surat_tgl); 
		...
		<?php 
			  $waktu_batas = db_to_human($addendum->surat_tgl_masuk); 
