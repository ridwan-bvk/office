...
?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="petugas_penerima" name="petugas_penerima" class="form-control" data-input-title="Nama Penerima" value="<?php echo $ref->petugas_pengirim; ?>" disabled="disabled" placeholder="Petugas Penerima">
						</div>
					</div>
				</div>
			</div>
